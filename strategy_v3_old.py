...
def build_candles(df, candle_seconds):
    # Determine price thresholds based on asset price range
    avg_price = df["price"].mean()
    # Scale thresholds: BTC~$80k uses $30/$50, ETH~$2k uses $1/$2, SOL~$100 uses $0.05/$0.1
...
def run(db_path, candle_seconds, label):
    ...
    # S5: Follow prev candle momentum
    ...
    # S6: Mean reversion after prev candle
...
BASE = r"C:\Users\James\BTC 5m poly trader"
markets = [
